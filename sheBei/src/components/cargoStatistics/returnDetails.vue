            ...
            <div class="orderNumber">
              <div class="titleContentleft">
                <div class="titleContent">
                  ...
                  <div :title="item.rejectedTime">
                    <span>退货时间：</span>
                    <span>{{ item.rejectedTime }}</span>
                  </div>
                  <div :title="item.deliverTime">
                    <span>交货日期：</span>
                ...
                <div :title="item.linkmanInfo" class="titleContent">
                  <div>
                    <span>联系人：</span>
                    <span>{{ item.linkmanInfo }}</span>
                  </div>
                  <div :title="item.confirmedAt" v-if="source === 'supply'">
                    <span>确认时间：</span>
                    <span>{{ item.confirmedAt }}</span>
                  </div>
                  <div
                    :title="item.confirmedOperatorName"
                    v-if="source === 'supply'"
                  >
                    <span>确认人：</span>
