...
export default {
  ...
  methods: {
    ...
    timeChange(event) {
      if (event === 'issuedTime') {
        this.searchParams.issuedAtStart =  this.issuedTime ? this.issuedTime[0] + ' 00:00:00' : ''
        this.searchParams.issuedAtEnd =  this.issuedTime ? this.issuedTime[1] + ' 23:59:59' : ''
      } else if (event === 'confirmedTime') {
        this.searchParams.confirmedAtStart =  this.confirmedTime ? this.confirmedTime[0] + ' 00:00:00' : ''
        this.searchParams.confirmedAtEnd =  this.confirmedTime ? this.confirmedTime[1] + ' 23:59:59' : ''
      } else if (event === 'deliveredTime') {
        this.searchParams.deliveredAtStart =  this.deliveredTime ? this.deliveredTime[0] + ' 00:00:00' : ''
        this.searchParams.deliveredAtEnd =  this.deliveredTime ? this.deliveredTime[1] + ' 23:59:59' : ''
      }
    },
    handleSearch () {
